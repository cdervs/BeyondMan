...
LIST statements_ = ritas_arrival, no_missing_property, scanner_malfunction, calm_neighbors, ritas_late_confession, elaines_confession, troys_ex
...
* {terrell_foe.drop_off_money or played_message} [Visit Troy Berkins.]
...
{sly > 4: She put a little too much effort on her appearance, given the circumstances. [Sly > 4]} #Thought
...
Cristina: Oh, my God. This is terrible ! But, how, why ? #Conv
    ...
    ** ["Someone wanted her gone."]
    ...
    -> cristina_questioning.told_cristina_about_rita
...
{evidence has claudias_records or statements has troys_ex:No way ! A symbol resembling the letter "A"! She's indeed a member of the "Arbor" !} #Thought
    ...
    **{evidence has claudias_records or statements has troys_ex} [Bring her in for questioning.]
...
Cristina: It's what we call "The Process". The evolution of humankind, but as you see, it doesn't end with the homo sapiens. We believe in a new hybrid form that is in early development, free from our flaws and self-destructive tendencies. #Conv
    ...
    * ["What do you do in this room ?"]
    ...
    Cristina: We meet here to discuss the present and the future of the community. Nothing more, nothing less. #Conv
        ...
        **["Do you need a secret trapdoor for that ?"]
        Noah: Do you need a secret trapdoor for that ? #Conv
        Cristina: 
-> END
...
- Rita: {not calm_down:Right... }After the initial shock, I reluctantly searched the house, while tightly holding a pocket knife I had with me. Right then, I immediately called Mr.Willford, the police and I notified some of the neighbors. #Conv
Rita: I stood outside by the street until the police arrived. I couldn't go back in there... #Conv
-> housekeeper3
...
Rita: Most of them like Mrs.Okamoto from D1, Mr.Richter from D2 and Ms.Artuso from C3 maintained their composure. Only a few panicked. #Conv
...
Mr.Richter: From there on, we were anxiously waiting for the police to arrive... #Conv
    ...
    **{analytical >= 3}["How come you didn't hear the gunshot ?"]
    ...
    {observant >= 5: His verbal flow is on point, but the detective senses a careful choice of words here. }
    -> richter_questions
        ...
        ***["What are you implying ?"]
        ...
        Mr.Richter: I've never seen the housekeeper here past 20:00. I just can't help but wonder if she could have anything to do with it. #Conv
            ...
            ****["Why would she ?"]
            ...
            Mr.Richter: I just can't suspect anyone else, except for Claudia herself. In order to have access into the building, an outsider should carry an official authorization by a resident of the building. If Claudia was killed by another third party, that would mean that the act was either carried out or authorized by another resident. #Conv
...
{(observant >= 4 or handyman >=4) and richter_drawers.tried_to_open :I could shape one of these paperclips into a makeshift lockpick. (Observant/Handyman > 3)} #Thought

{(observant >= 4 or handyman >=4) and richter_drawers.tried_to_open:Noah takes one of the paperclips. (Observant/Handyman > 3)}
...
= carsen_2
Further down the street, there is a group of stoned, alternative folks, rhytmically singing along to some ethnic music, coming from a bohemian bar, right behind them.
...
= skid
Noah and {partner} go over to Skid's table. A little bit stoned, he is sitting with two lightly dressed women, one by each side.
...
Skid: No need to get hot, brother. You don't want to do business, it's fine. Go find yourselves a table and enjoy your time. First drink on me. #Conv
    ...
    ** (threaten) {audacious > 3} [Threaten him on the spot. (Audacious)]
...
Skid: Not much, really, I don't know any of them. It's an elitist group with lots of money behind them. All of them also bear a symbol on their skin, a shape or something. That much I know. #Conv
    ...
    **** {skid_choice.lure && (audacious > 5 or rogue > 5)} [Shove the gun on his head.]
...
=== rita_reveal ===
Noah receives an anonymous call.

Noah: Who is this ? #Conv
Rita: Mr.Taulen, this is Rita. Uhh, Rita Stamopoulos, Mrs.Willford's housekeeper.
...
Noah: Good afternoon, Miss. #Conv
    ...
    ** [Pretend to be a cult recruiter.]
    ...
    Young Woman: Oh no, I'm afraid you lucked out, I'm not into these neo-scientific cults, with all due respect. #Conv
...
The three men head off to a nearby park.
}
